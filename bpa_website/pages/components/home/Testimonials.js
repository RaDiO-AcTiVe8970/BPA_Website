...
function Testimonials() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch('http://localhost:3000/api/bpa/admin/getAllTestimonials');
      const data = await response.json();

      // Set the testimonials data in the state
              ...
              return (
                ...
                >
                  <figure className="px-10 pt-10">
                    ...
                    <img
                      className="mask w-16 h-16 mask-circle"
                      src={testimonial.image} // Replace with the image path
                      alt=""
                    />
                  </figure>
                  <div className="card-body items-center text-center">
